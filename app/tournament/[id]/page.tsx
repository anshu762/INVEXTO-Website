          ...
          <div className="mx-auto max-w-3xl space-y-6">
            <div className="rounded-2xl border border-emerald-700/30 bg-emerald-900/30 p-5">
              <div className="flex flex-wrap items-center justify-between gap-4">
                ...
                <Link
                  href={`/tournament/${data.tournament.id}/leaderboard`}
                  className="inline-flex items-center gap-2 rounded-xl bg-emerald-600 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-emerald-500 shadow-lg shadow-emerald-900/20"
                >
                  View Leaderboard
              ...
              {data.portfolio ? (
                <div className="rounded-xl border border-emerald-800/20 bg-emerald-950/30 p-6 shadow-inner">
                  ...
                  <p className="text-xs text-emerald-600/80 mt-4">
                    Stock holdings and rankings are visible on the leaderboard.
                  </p>
                </div>
              ) : (
