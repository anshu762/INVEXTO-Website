...
const stocks: StockDef[] = [
  ...
  { symbol: "TMPV.NS", name: "Tata Motors Passenger Vhcls Ltd", sector: "Auto", faceValue: 2 },
...
const currentPrices: Record<string, number> = {
  ...
  "MARUTI.NS": 10500, "TMPV.NS": 950, "BAJAJ-AUTO.NS": 7800, "HEROMOTOCO.NS": 4800, "M&M.NS": 1800,
...
const previousClosePrices: Record<string, number> = {
  ...
  "MARUTI.NS": 10400, "TMPV.NS": 930, "BAJAJ-AUTO.NS": 7750, "HEROMOTOCO.NS": 4750, "M&M.NS": 1770,
...
const sharesOutstanding: Record<string, number> = {
  ...
  "MARUTI.NS": 3_16_00_000, "TMPV.NS": 7_63_00_000, "BAJAJ-AUTO.NS": 3_06_00_000, "HEROMOTOCO.NS": 2_00_00_000, "M&M.NS": 12_56_00_000,
...
const keyStatsData: Record<string, Record<string, number>> = {
  ...
  "TMPV.NS": { ttmEps: 35, pbRatio: 2.5, sectorPe: 22, bookValue: 380, dividendYield: 0.8, beta: 1.3, avgVolume20d: 8500000, avgDeliveryPct20d: 48 },
